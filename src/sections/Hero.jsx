  ...
  return (
    <section className="flex lg:flex-row flex-col-reverse ">
      <header className="lg:w-[50%] w-full">
        <div className="">
          <h1 className="lg:text-[60px] text-[48px] leading-[60px] font-bold  ">Sage </h1>
          <h1 className="lg:text-[60px] text-[48px] leading-[60px] font-bold  ">Tech </h1>
          <h1 className="lg:text-[60px] text-[48px] leading-[60px] font-bold  ">Portland's Most Trusted Tech Support</h1>
